...
| /etc        | 存放系统管理和配置文件                                       |
| /home       | 存放所有用户文件的根目录，是用户主目录的基点，比如用户user的主目录就是/home/user，可以用~user表示![img](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312337694.jpeg) |
...
![img](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312337863.png) 
