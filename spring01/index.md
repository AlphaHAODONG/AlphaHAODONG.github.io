...
![](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331234.png)
...
![image-20210729174148134](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331218.png)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!--
    	...
    	class属性：表示给bean定义类型
	-->
    <bean id="bookService" class="com.itghd.service.impl.BookServiceImpl"></bean>
...
![image-20210729184337603](D:\新建文件夹\_posts\image-20210729184337603.png)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="bookService" class="com.itghd.service.impl.BookServiceImpl">
        <!--配置server与dao的关系
...
![image-20210729183104748](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331460.png)
...
![image-20210729183500978](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331294.png)
...
![image-20210729183558051](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331205.png)

#### 代码演示

![image-20210729191924626](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331252.png)

#### 打印结果

![image-20210729191954870](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331069.png)
...
![image-20210729183628138](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331831.png)

> 扩展：scope的取值不仅仅只有singleton和prototype，还有request、session、application、 websocket ，表示创建出的对象放置在web容器(tomcat)对应的位置。比如：request表示保存到request域中。

#### 代码演示

![image-20210729192420048](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331013.png)

#### 打印结果

![image-20210729192730871](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331876.png)
...
![image-20210729194137151](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331908.png)
...
```xml
<!--方式二：使用静态工厂实例化bean-->
<bean id="orderDao" class="com.itghd.factory.OrderDaoFactory" factory-method="getOrderDao"/>
```

![image-20210729195248948](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331026.png)
...
![image-20210729195009198](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331266.png)
...
```xml
<!--方式三：使用实例工厂实例化bean-->
<bean id="userFactory" class="com.itghd.factory.UserDaoFactory"/>

<bean id="userDao" factory-method="getUserDao" factory-bean="userFactory"/>
```

![image-20210729200203249](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331413.png)
...
![image-20210729200240820](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331427.png)
...
![image-20210729203626540](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331495.png)

##### 简单类型

![image-20210729203728173](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331592.png)
...
![image-20210729203859855](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331666.png)

##### 简单类型

![image-20210729204006542](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331744.png)

##### 参数适配【了解】

![image-20210729204117697](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331943.png)
...
> <groupId>mysql</groupId>
> <artifactId>mysql-connector-java</artifactId>
> <version>8.0.27</version> <!-- 使用最新的 MySQL Connector 版本 -->
> </dependency>
> ```
>
...
![image-20210730101826913](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331019.png)

**==小技巧：如果同学们觉得上述复制粘贴方式不好改或者容易改错，其实idea是有提示功能的，注意不要选错就行了。有些版本的idea没有这个提示，那么就按照上面复制粘贴的方式改，改完之后可以做成live template模板，后期直接用。==**

![image-20210730102053281](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331069.png)
...
![image-20210730102842030](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331300.png)
...
![image-20210730103438742](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331180.png)

#### 2.3 依赖注入相关

![image-20210730103701525](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331269.png)
...
![image-20210730104835746](D:\新建文件夹\_posts\image-20210730104835746.png)
...
![image-20210803192052811](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331527.png)
...
![image-20210730113548708](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331578.png)
...
![image-20210730114303147](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331620.png)

##### 1.1.2 整合MyBatis

- 使用SqlSessionFactoryBean封装SqlSessionFactory需要的环境信息

![image-20210730114342060](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331782.png)

- 使用MapperScannerConfigurer加载Dao接口，创建代理对象保存到IOC容器中

![image-20210730114356175](https://alphaguo-1322521250.cos.ap-beijing.myqcloud.com/202312312331848.png)
...
##### **【第一步】导入Spring整合Mybatis依赖**(JAVA17)
...
![image-20210730144903209](D:\AlphaGuoBlog\quark01\assets\image-20210730144903209.png)
...
![image-20210730150138448](D:\AlphaGuoBlog\quark01\assets\image-20210730150138448.png)
...
![image-20210730151347354](D:\AlphaGuoBlog\quark01\assets\image-20210730151347354.png)
...
![image-20210730152631741](D:\AlphaGuoBlog\quark01\assets\image-20210730152631741.png)
...
![image-20210730153824117](D:\AlphaGuoBlog\quark01\assets\image-20210730153824117.png)
...
![image-20210730164219555](D:\AlphaGuoBlog\quark01\assets\image-20210730164219555.png)
...
![image-20210731193059709](D:\AlphaGuoBlog\quark01\assets\image-20210731193059709.png)
...
![image-20210801190820853](D:\AlphaGuoBlog\quark01\assets\image-20210801190820853.png)
...
![image-20210801192453227](D:\AlphaGuoBlog\quark01\assets\image-20210801192453227.png)
...
![image-20210802151553053](D:\AlphaGuoBlog\quark01\assets\image-20210802151553053.png)
...
![image-20210802153216460](D:\AlphaGuoBlog\quark01\assets\image-20210802153216460.png)
...
![image-20210802153014296](D:\新建文件夹\_posts\assets\image-20210802153014296.png)
